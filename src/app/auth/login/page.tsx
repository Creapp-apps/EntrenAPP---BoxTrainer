      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <div className="relative flex py-4 items-center mt-2">
            ...
            <span className="flex-shrink mx-4 text-muted-foreground text-[10px] uppercase tracking-wider font-semibold bg-white px-1">
              O continuar con
            </span>
            <div className="flex-grow border-t border-slate-100"></div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-medium py-3 rounded-xl transition disabled:opacity-60 shadow-sm"
          >
