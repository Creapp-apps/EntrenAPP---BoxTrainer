-- ============================================================
-- MIGRATION 013 — Fix copy_cycle: use gen_random_uuid() + copy training_complex_sets
    ...
    loop
      ...
      loop
        ...
        for v_ex in
          ...
          order by "order"
        loop
          -- Mapear complex_id viejo → nuevo UUID
