-- ============================================================
-- MIGRATION 044 — Fix copy_cycle regressions and drop old signature
-- 1. Drops the old 6-argument overloaded copy_cycle function to prevent ambiguity.
-- 2. Restores full copying logic for training_complex_sets, cycle_type, wod_type,
--    wod_config, and crossfit data (cf_block_exercises, cf_wod_levels).
-- ============================================================

-- Drop the old 6-parameter version
DROP FUNCTION IF EXISTS public.copy_cycle(uuid, uuid, text, date, uuid, boolean);

-- Recreate the new 5-parameter version with all copying logic restored
